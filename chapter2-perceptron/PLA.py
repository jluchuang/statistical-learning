#coding:utf-8
#This code is copy from https://github.com/hancyxhx/perceptron-learning-algorithm/blob/master/PLA.py
#This page is useful: https://zhuanlan.zhihu.com/p/25358695
...
def noMistakePoint(training_data, w):
    ...
    for (x, y) in training_data:
        predict = w.transpose() * x
        print("preidct:",predict)
        if mSign(predict) != sign(y):
            status = 'NO'
            return (status, x, y)
